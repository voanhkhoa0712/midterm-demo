import NewsItem from '../../docs/components/NewsItem/NewsItem.js';
import NavItem from '../../docs/components/DashboardPage/Navbar/NavItem.js';
import PaperItem from '../../docs/components/DashboardPage/PaperDashboard/PaperItem.js';
import CommentAreaItem from '../../docs/components/NewsDetailPage/CommentArea/CommentAreaItem/CommentAreaItem.js';
import SuggestionItem from '../../docs/components/NewsDetailPage/Suggestion/SuggestionItem/SuggestionItem.js';
...
export const dataToDescriptionList = (data) =>
  data.map((d) => {
    ...
    <div class="desc-image-container">
      <img class="desc-image" src=${d.value.docs} alt="Illustration" />
