import { loadHighlightDataOfType } from '../../../docs/utils/loadData.js';
import { dataToNewsItemList } from '../../../docs/utils/createHtmlElements.js';
import { CATEGORY, CONTEXT } from '../../../docs/utils/constants.js';
import { headlineOfType } from '../../../docs/utils/createHeadline.js';
import { HomepageHeadline, NewsListHeadline } from '../../../docs/components/Highlight/Headline/Headline.js';
   ...
   <div class="main__highlight grid-container">
     ...
     ${
       Number(sessionStorage.getItem('navigator')) === CONTEXT.HOMEPAGE
         ? `<a href='../../../docs/pages/NewslistPage.html' class="see-more-btn" id="see-more-${type}">Xem thêm</a>`
         : ''
     }
   </div>
    `;
