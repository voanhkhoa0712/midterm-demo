...
export const NewsListHeadline = (cate, tag = '') => {
  ...
  return `<div class="newslist-headline">
        <a href="../../../../docs/pages/NewslistPage.html" class="cate-headline-text" id="cate-headline" data-value=${
          cate.id
        }>${cate.label}</a>
        ${
          tag !== '' // if render tag news
            ? `<a href="../../../../docs/pages/NewslistPage.html" class="subcate-headline-text" data-value=${tag}>${tag}</a>`
            : `<a href="../../../../docs/pages/NewslistPage.html" class="subcate-headline-text" data-value=${
