import { CATEGORY } from '../../../docs/utils/constants.js';
...
const categoryElements = (data) => {
  ...
  for (let key in data) {
    res.push(`
    <a href="../../../docs/pages/NewslistPage.html" class="header__category-container header-item" data-value=${data[key].id}>
      ${data[key].label}
...
const MiddleHeader = `
    <div class="header__middle" id="sticky-header">
        <a href="../../../docs/index.html" class="header__home-container header-item" data-value="home">
