import CommentArea from '../../../../docs/components/NewsDetailPage/CommentArea/CommentArea.js';
import Suggestion from '../../../../docs/components/NewsDetailPage/Suggestion/Suggestion.js';
import { dataToDescriptionList, dataToTagList } from '../../../../docs/utils/createHtmlElements.js';
...
const NewsDetail = (data) => `
    <div class="news-detail-container">
        ...
        <div class="detail-cate-and-date">
            <a href="../../../../docs/pages/NewslistPage.html" id="detail-cate" class="detail-cate">${data.cate}</a>
