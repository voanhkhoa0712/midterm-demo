...
import Footer from '../../../docs/components/Footer/Footer.js';
import NewsDetail from '../../../docs/components/NewsDetailPage/NewsDetail/NewsDetail.js';
import { handleSticky } from '../../../docs/utils/handleSticky.js';
import { handleNavigateToNewslistPage } from '../../utils/addOnclick.js';

const sampleData = {
  id: '',
  thumbnail: '../../../../docs/public/images/messi.png',
  ...
  descriptions: [
    ...
    },
    {
      type: 'image',
      value: {
        docs: '../../../../docs/public/images/messi.png',
        caption:
