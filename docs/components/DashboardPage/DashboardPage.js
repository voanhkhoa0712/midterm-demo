import Header from '../../../docs/components/Header/Header.js';
import Navbar from '../../../docs/components/DashboardPage/Navbar/Navbar.js';
import AccountInfo from '../../../docs/components/DashboardPage/Info/AccountInfo.js';
import WriterInfo from '../../../docs/components/DashboardPage/Info/WriterInfo.js';
import WriterEditor from '../../../docs/components/WriterEditor/WriterEditor.js';
import PaperDashboard from '../../../docs/components/DashboardPage/PaperDashboard/PaperDashboard.js';
import { CONTEXT, NAV_ITEM, POPUP_INPUT_DETAIL } from '../../../docs/utils/constants.js';
import { handleSticky } from '../../../docs/utils/handleSticky.js';
import { addOnclickToClassname } from '../../../docs/utils/addOnclick.js';
import { openPopup } from '../../../docs/utils/handlePopup.js';
import EditorInfo from '../../../docs/components/DashboardPage/Info/EditorInfo.js';
import Premium from '../../../docs/components/DashboardPage/Premium/Premium.js';
...
const handleOnClick = (e) => {
  ...
  switch (target.getAttribute('value')) {
    ...
    case 'log-out': {
      ...
      window.location.assign('../../../docs/pages/LoginPage.html');
      break;
    }
    case 'premium': {
      target.style.backgroundColor = 'rgba(255,255,255,0.2)';
