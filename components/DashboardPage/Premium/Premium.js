import { convertMinutes } from "../../../../midterm-demo/utils/timer.js";
import Logo from "../../Logo/Logo.js";

const Premium = (timeLeft) => `
    <div class="premium-container">
        ${Logo(
          "dark-red-backgroundcolor premium-logo",
          "white-color",
          "black-color",
          "premium-logo"
        )}
        ...
        <p class="premium-time-left">${
          timeLeft > 0 ? `Thời gian còn lại: ${convertMinutes(timeLeft)}` : ""
        }</p>
        <button class="premium-btn" id="premium-btn">${
          timeLeft > 0 ? "Gia hạn gói Premium" : "Đăng ký ngay"
        }</button>
