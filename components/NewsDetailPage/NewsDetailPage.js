...
import NewsDetail from "../../../midterm-demo/components/NewsDetailPage/NewsDetail/NewsDetail.js";
import { handleSticky } from "../../../midterm-demo/utils/handleSticky.js";
import { handleNavigateToNewslistPage } from "../../utils/addOnclick.js";

const sampleData = {
  id: "",
  thumbnail: "../../../../midterm-demo/public/images/messi.png",
  ...
  descriptions: [
    ...
    },
    {
      type: "image",
      value: {
        source: "../../../../midterm-demo/public/images/messi.png",
        caption:
