    ...
    <div class="header__top">
        ...
        <div class="header__top-middle">
          <nav class="header__top-navbar">
              <a href="../../../midterm-demo/pages/NewslistPage.html" class="header__top-navItem header-item" data-value="0">${
                headerTopItems[0].title
              }</a>
              <a href="../../../midterm-demo/pages/NewslistPage.html" class="header__top-navItem header-item" data-value="1">${
        ...
        <div class="header__top-right">
          ...
          <div class="header__top-userIconContainer">
              <a class="header__top-userIcon" href=${
                isGuest
                  ? "../../../midterm-demo/pages/LoginPage.html"
                  : "../../midterm-demo/pages/DashboardPage.html"
